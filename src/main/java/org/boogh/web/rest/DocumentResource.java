...
public class DocumentResource {
    ...
    public ResponseEntity<Document> createDocument(@Valid @RequestBody Document document) throws URISyntaxException {
        ...
        // Check if there exist a document of this type
        List<Document> docs = documentRepository.findDocumentByType(document.getType());
        if (docs.size() != 0) {
            Document previousDocument = docs.get(0);
            previousDocument.setContent(document.getContent());
