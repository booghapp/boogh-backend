...
public class ReportStatusCriteria implements Serializable {
    /**
     * Class for filtering ReportStatusState
     */
    public static class ReportStatusStateFilter extends Filter<ReportStatusState> {
    }
    ...
    private ReportStatusStateFilter saved;

    private ReportStatusStateFilter flagged;
    ...
    public ReportStatusStateFilter getSaved() {
        return saved;
    }

    public void setSaved(ReportStatusStateFilter saved) {
        this.saved = saved;
    }

    public ReportStatusStateFilter getFlagged() {
        return flagged;
    }

    public void setFlagged(ReportStatusStateFilter flagged) {
