            ...
            <Row>
                <Col md="8">
                    ...
                    <dl className="jh-entity-details">
                        ...
                        <dd style={{ direction: 'rtl', textAlign: 'right' }}>{commentEntity.content}</dd>
                        <dt>
                            <span id="date">Date</span>
                        </dt>
                        <dd>
                            <TextFormat value={commentEntity.date} type="date" format={APP_LOCAL_DATE_FORMAT} />
                        </dd>
                        <dt>Commenter</dt>
                        <dd>{commentEntity.commenter ? commentEntity.commenter.login : ''}</dd>
                        <dt>Report</dt>
                        <dd>{commentEntity.report ? commentEntity.report.id : ''}</dd>
                        <dt>Parent</dt>
